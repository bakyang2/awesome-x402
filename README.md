...
- [KR Crypto Intelligence](https://api.printmoneylab.com) — Korean data API for AI agents with 15 paid endpoints: 11 crypto (Kimchi Premium across 180+ tokens, Upbit/Bithumb prices, AI-powered Korean sentiment analysis (world's first), Global vs Korea divergence with structured AI breakdown, market alerts) + 4 Korean news → English (K-pop artists, semiconductor industry with AI sentiment analysis). $0.001-$0.10 USDC per call on Base, Polygon, and Solana. AWS Bedrock AgentCore-ready. [Source](https://github.com/bakyang2/kr-crypto-intelligence)
